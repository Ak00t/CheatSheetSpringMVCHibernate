...
<body>
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="fw-bold" style="color: #2563eb;">👥 My Followers</h1>
        ...
        <div id="followersFeedArea">
            <div id="followersContainer" class="grid">
                <!-- Ajax ကနေ ရလာမယ့် Followers Card တွေ ဒီထဲမှာ ပေါ်လာပါမယ် -->
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            if(typeof loadFollowSystemFeed === 'function') {
                loadFollowSystemFeed('followers');
            }
        });
    </script>
</body>
