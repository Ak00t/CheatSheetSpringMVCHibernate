...
<style>
    @media (min-width: 768px) {
        ...
        .profile-hover-dropdown .dropdown-menu::before {
            content: "";
            position: absolute;
            top: -20px; /* အပေါ်ဘက် ကွက်လပ်နေရာအလိုက် layer အား လှမ်းဆွဲဆန့်ထားခြင်း */
            left: 0;
            width: 100%;
            height: 20px;
    ...
    .custom-grid-menu {
        ...
        left: auto !important; 
        right: 0 !important; 
        transform: translateX(10px); /* Screen အပြင်မထွက်အောင် ဘယ်ဘက်ကို နည်းနည်းပြန်တွန်းထားသည် */
    }
            ...
            <div class="modal-body p-4">
                ...
                <form action="${pageContext.request.contextPath}/login" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="loginPasswordInput" name="password" class="form-control border-end-0 custom-placeholder" required="required" placeholder="••••••••" />
                            <button class="input-group-text bg-white border-start-0 text-muted" type="button" id="togglePasswordBtn" style="cursor: pointer;">
            ...
            <div class="modal-body p-4">
                ...
                <form action="${pageContext.request.contextPath}/register" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-secondary">Password</label>
                        <div class="input-group">
                            <input type="password" id="registerPasswordInput" name="password" class="form-control border-end-0 custom-placeholder" placeholder="Create password" required="required" />
                            <button class="input-group-text bg-white border-start-0 text-muted" type="button" id="toggleRegPasswordBtn" style="cursor: pointer;">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="password" id="registerConfirmPasswordInput" name="confirmPassword" class="form-control border-end-0 custom-placeholder" placeholder="Repeat password" required="required" />
                            <button class="input-group-text bg-white border-start-0 text-muted" type="button" id="toggleRegConfirmPasswordBtn" style="cursor: pointer;">
