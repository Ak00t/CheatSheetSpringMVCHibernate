            ...
            <body>
                ...
                <div class="container py-4">
                    ...
                    <%-- <nav aria-label="breadcrumb" class="mb-3">
                        ...
                        <<<<<<< HEAD <div class="card shadow-sm border-0 rounded-3 p-3 mb-5 bg-white">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                <div class="d-flex align-items-center gap-4">
                                    <div class="text-secondary d-flex align-items-center gap-2">
                                        <i class="bi bi-eye-fill fs-5 text-muted"></i>
                                        <span class="fw-medium">${not empty cheatsheet.viewCount ? cheatsheet.viewCount
                                            : 0} Views</span>
                                    </div>
                                    <button class="action-icon-btn d-flex align-items-center gap-2"
                                        onclick="toggleLike(${cheatsheet.id})">
                                        <i class="bi bi-heart fs-5 text-danger" id="likeBtnIcon"></i>
                                        <span class="fw-medium text-dark" id="likeCounterText">${not empty
                                            cheatsheet.likeCount ? cheatsheet.likeCount : 0}</span>
                                    </button>
                                    <button class="action-icon-btn d-flex align-items-center gap-2"
                                        onclick="toggleBookmark(${cheatsheet.id})">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            ...
                                            <div class="d-flex align-items-center gap-4">
                                                <form action="${pageContext.request.contextPath}/cheatsheet/like"
                                                    ...
                                                    <button type="submit"
                                                        class="action-icon-btn d-flex align-items-center gap-2">
                                                        <i
                                                            class="bi ${isLiked ? 'bi-heart-fill text-danger' : 'bi-heart'} fs-5"></i>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu p-3 shadow border-0"
                                                        style="width: 200px;">
                                                        <form
                                                            action="${pageContext.request.contextPath}/cheatsheet/rate"
                                                            method="POST">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-dark btn-sm w-100">Submit Rating</button>
                                                        </form>
                                                    </div>
                                                    >>>>>>> origin/SLYAv51
                                                </div>
                                            ...
                                            <div class="bookmark-container">
                                                <form action="${pageContext.request.contextPath}/cheatsheet/bookmark"
                                                    method="POST" style="display:inline;">
                                                    <input type="hidden" name="cheatsheetId" value="${cheatsheet.id}" />
                            ...
                            <div class="card border-0 shadow-sm p-4 rounded-4 bg-white mb-5">
                                ...
                                <form class="mb-4" method="post"
                                    ...
                                    <button type="submit" class="btn btn-dark px-4 fw-bold rounded-2">Post
                                        Comment</button>
                                </form>
                                                            ...
                                                            <ul
                                                                ...
                                                                <li id="translateOpt-${comment.id}">
                                                                    <a class="dropdown-item d-flex align-items-center gap-2 text-success py-2"
                                                                        ...
                                                                        <i class="bi bi-translate"></i> Translate to
                                                                        Burmese
                                                                    </a>
                                                                </li>
                                                                ...
                                                                <li id="originalOpt-${comment.id}" class="d-none">
                                                                    <a class="dropdown-item d-flex align-items-center gap-2 text-secondary py-2"
                                                                        ...
                                                                        <i class="bi bi-arrow-clockwise"></i> See
                                                                        Original
                                                                    </a>
                                                                </li>
                                                            </ul>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow">
                            <div class="modal-header bg-light">
                                <h5 class="modal-title fw-bold text-dark"><i class="bi bi-share-fill me-2"></i> Share
                                    Sheet Hyperlink</h5>
                            ...
                            <div class="modal-body p-4">
                                <div class="input-group">
                                    <input type="text" class="form-control bg-light" id="deploymentLinkInput"
                                    ...
                                    <button class="btn btn-dark fw-bold" type="button"
                                        onclick="copyDeploymentLink()">Copy Path</button>
                                </div>
                            </div>
                        </div>
                    </div>
