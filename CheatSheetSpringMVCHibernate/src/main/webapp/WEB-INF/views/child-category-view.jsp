...
/* CHEATSHEET CARD - ပုံစံခွက်အတွင်း စာသားများ ကွက်တိဖြစ်စေရန် စနစ်တကျ ပြန်ပြင်ထားပါသည် */
.sheet-card{
    flex:0 0 380px;
    border-radius:28px;
    overflow:hidden;
    ...
    height: 500px;            /* ကတ်ပြားတစ်ခုလုံးကို အရွယ်အစား ပုံသေ သတ်မှတ်လိုက်ပါသည် */
}
...
.sheet-body{
    ...
    flex-direction: column;
    flex-grow: 1;
    overflow: hidden;         /* စာသားများ အပြင်သို့ မလျှံထွက်စေရန် */
}
...
.sheet-footer{
    margin-top: auto;        /* Created By ကို အောက်ခြေသို့ ကပ်ထားရန် */
    padding-top: 12px;
