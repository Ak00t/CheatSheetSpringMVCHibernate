                ...
                <body>
                    ...
                    <div class="container">
                        ...
                        <div class="folder-grid">
                            ...
                            <div class="folder-card all" onclick="toggleFolder('allFolder', this)">
                            ...
                            <div class="folder-card published" onclick="toggleFolder('publishedFolder', this)">
                            ...
                            <div class="folder-card draft" onclick="toggleFolder('draftFolder', this)">
                            ...
                            <div class="folder-card archived" onclick="toggleFolder('archivedFolder', this)">
                            ...
                            <div class="folder-card private" onclick="toggleFolder('privateFolder', this)">
                                    ...
                                    <div class="sheet-card"
                                        ...
                                        <a href="${pageContext.request.contextPath}/profile-cheatsheets/detail/${sheet.id}"
                                            ...
                                            <div class="sheet-body">
                                                ...
                                                <div class="sheet-footer">Created By: <span
                                                        class="creator-link">${sheet.user.name}</span></div>
                                            </div>
                                        </a>
                                    </div>
                                </c:forEach>
                                            ...
                                            <div class="sheet-card" style="background-color: ${sheet.themeColor};">
                                                ...
                                                <a href="${pageContext.request.contextPath}/profile-cheatsheets/detail/${sheet.id}"
                                                    ...
                                                    <div class="sheet-cover">
                                                        <c:choose>
                                                            <c:when
                                                                test="${not empty sheet.mediaList and not empty sheet.mediaList[0].mediaUrl}">
                                                                <%-- mediaUrl က /uploads/cheatsheets/ နဲ့ စတဲ့အတွက်
                                                                    contextPath နောက်မှာ တန်းထည့်ပါ --%>
                                                            ...
                                                            <c:otherwise>
                                                                <span style="color:white; font-size:12px;">No
                                                                    Image</span>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </div>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/profile-cheatsheets/detail/${sheet.id}"
                                                            ...
                                                            <div class="sheet-body">
                                                                ...
                                                                <%-- <div class="sheet-footer-actions">
                                                                    <a href="${pageContext.request.contextPath}/profile-cheatsheets/edit/${sheet.id}"
                                                                        class="btn-action btn-profile-edit">
                                                                        ✏️ Edit
                                                                    </a>

                                                                    <form
                                                                        action="${pageContext.request.contextPath}/profile-cheatsheets/delete/${sheet.id}"
                                                                        method="post" style="flex: 1; display: flex;"
                                                                        onsubmit="return confirmDelete();">
                                                                        <button type="submit"
                                                                            class="btn-action btn-profile-delete">
                                                                            🗑️ Delete
                                                                        </button>
                                                                    </form>
                                                            </div> --%>
                                                            <div class="sheet-footer">
                                                                ...
                                                                🗓
                                                                <%-- အရင်ရှိတဲ့ fmt:parseDate ကို ဖျက်ပြီး ဒါနဲ့
                                                                    အစားထိုးလိုက်ပါ --%>
                                                                    <c:set var="datePart"
                                            ...
                                            <a href="${pageContext.request.contextPath}/profile-cheatsheets/detail/${sheet.id}"
                                                ...
                                                <div class="sheet-body">
                                                    ...
                                                    <div class="sheet-footer">
                                                        ...
                                                        🗓
                                                        <fmt:parseDate value="${sheet.createdAt}"
                                                            pattern="yyyy-MM-dd'T'HH:mm:ss" var="createdDate" />

                                                        <fmt:formatDate value="${createdDate}" pattern="dd MMM yyyy" />
                                                    </div>
                    ...
                    <div id="unlistedFolder" class="folder-content">
