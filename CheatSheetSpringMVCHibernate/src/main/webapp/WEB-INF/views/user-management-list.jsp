...
<head>
    ...
    <style>
        ...
        /* Existing custom styles kept for user list... */
                                    ...
                                    <div class="user-card-item" data-name="${user.name.toLowerCase()}">
                                        ...
                                        <div class="account-horizontal-box">
                                            <div class="box-left-section">
                                                <img src="${not empty user.profileImg ? user.profileImg : 'https://ui-avatars.com/api/?name='.concat(fn:replace(user.name, ' ', '+'))}" class="box-avatar" />
                                            ...
                                            <div class="account-actions">
                                                <c:if test="${user.id eq sessionScope.currentUser.id}"><span class="current-user-badge">You</span></c:if>
                                            </div>
                                        </div>
                                    </div>
                                </c:if>
