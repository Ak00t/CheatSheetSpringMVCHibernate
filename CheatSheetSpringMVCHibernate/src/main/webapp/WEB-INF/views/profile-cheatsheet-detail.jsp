            ...
            <body>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="owner-actions">
                                ...
                                <form class="owner-delete-form"
                                    ...
                                    method="post" onsubmit="return confirm('ဤ Cheat Sheet အား ဖျက်ရန် သေချာပါသလား?');">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu p-3 shadow border-0" style="width: 200px;">
                                            <form action="${pageContext.request.contextPath}/cheatsheet/rate"
                                                method="POST">
                                                <input type="hidden" name="cheatsheetId" value="${cheatsheet.id}" />
                ...
                <div class="card border-0 shadow-sm p-4 rounded-4 bg-white mb-5">
                    ...
                    <form class="mb-4" method="post" action="${pageContext.request.contextPath}/comment/post">
                        <input type="hidden" name="cheatsheetId" value="${cheatsheet.id}" />
                        <div class="mb-3">
                            <textarea class="form-control p-3 border rounded-3" style="min-height:95px;" name="content"
                                placeholder="Share your perspective or ask a question..." required></textarea>
                        </div>
                            ...
                            <c:otherwise>
                                <c:forEach items="${comments}" var="comment">
                                    <div class="card bg-light border-0 p-3 mb-3 rounded-3 position-relative shadow-sm">
                                        ...
                                        <div id="edit-form-${comment.id}" class="mt-3 p-3 bg-white border rounded-3"
                                            style="display:none;">
                                            <form method="post"
                                        ...
                                        <div id="reply-form-${comment.id}" class="mt-3 p-3 bg-white border rounded-3"
                                            style="display:none;">
                                            <form method="post"
