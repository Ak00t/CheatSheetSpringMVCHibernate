...
<h2 style="margin-bottom:20px;color:#2563eb;">📢 Published</h2>
<c:choose>
...
<c:otherwise><div class="empty-box">No published cheatsheets.</div></c:otherwise>
</c:choose>

<h2 style="margin:50px 0 20px;color:#f59e0b;">📝 Draft</h2>
<c:choose>
...
<c:otherwise><div class="empty-box">No drafts.</div></c:otherwise>
</c:choose>

<h2 style="margin:50px 0 20px;color:#64748b;">📦 Archived</h2>
<c:choose>
...
<c:otherwise><div class="empty-box">No archived cheatsheets.</div></c:otherwise>
</c:choose>

<h2 style="margin:50px 0 20px;color:#dc2626;">🔒 Private</h2>
<c:choose>
...
<c:otherwise><div class="empty-box">No private cheatsheets.</div></c:otherwise>
</c:choose>
