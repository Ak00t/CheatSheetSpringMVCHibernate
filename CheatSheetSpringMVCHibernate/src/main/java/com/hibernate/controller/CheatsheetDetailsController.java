...
public class CheatsheetDetailsController {
    ...
    @ResponseBody
    public String logCheatsheetShare(@RequestParam Long cheatsheetId, @RequestParam String platform, HttpSession session) {
        UserEntity user = (UserEntity) session.getAttribute("currentUser");
        if (user != null) {
    ...
    public String submitReport(@RequestParam Long targetId, @RequestParam String reason, @RequestParam(required = false) String description, HttpSession session) {
        UserEntity user = (UserEntity) session.getAttribute("currentUser");
        if (user != null) {
